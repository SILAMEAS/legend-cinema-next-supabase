...
export default function CorporateAdminLayout({
    ...
    useEffect(() => {
        if (user&&user?.role !== EnumRole.CORPORATE) {
            ...
            <main className="flex-1 overflow-auto">
                <div className="bg-gray-900 border-b border-gray-800 px-8 py-4">
                    <div className="flex items-center justify-between">
                        <h2 className="text-2xl font-semibold text-white">Corporate Dashboard</h2>
                        <div className="flex items-center gap-4">
                            <span className="text-sm text-gray-400">Welcome, Corporate</span>
                            <div
