import { Search, Bell, ChevronDown, MapPin, TicketIcon, User } from "lucide-react"
            ...
            <header className="border-b border-zinc-800">
                <div className="container mx-auto px-6 py-4">
                    <div className="flex items-center justify-between">
                        {/* Search Bar */}
                        <div className="flex items-center gap-2 bg-zinc-900 rounded-md px-4 py-2 w-64">
                            <input
                                type="text"
                        ...
                        <div className="flex items-center gap-4">
                            <Button variant="ghost" size="sm" className="text-white hover:text-white hover:bg-zinc-900">
                            ...
                            <button className="flex items-center gap-1 px-3 py-2 hover:bg-zinc-900 rounded-md">
