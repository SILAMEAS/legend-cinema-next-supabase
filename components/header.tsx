...
import { Search, Bell, ChevronDown, MapPin, TicketIcon, User, Menu, X } from "lucide-react"
                ...
                <div className="container mx-auto px-4 md:px-6 py-3 md:py-4">
                    <div className="flex items-center justify-between gap-4">
                        ...
                        <Link href={EnumPage.ROOT} className="flex flex-col items-center flex-1 lg:flex-none">
                            ...
                            <div className="text-[7px] md:text-[8px] tracking-[0.2em] text-zinc-400 mt-0.5">CINEMAS</div>
                        </Link>
                        ...
                        <div className="flex items-center gap-2 md:gap-4">
                            ...
                            <button className="hidden md:flex items-center gap-1 px-3 py-2 hover:bg-zinc-900 rounded-md">
                                <Image src="/us-flag-waving.png" alt="EN" width={24} height={16} className="rounded-sm" />
                ...
                <div className="lg:hidden fixed inset-0 z-50 bg-black/95">
                    <div className="container mx-auto px-4 py-6">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <button className="p-2 hover:bg-zinc-900 rounded-md" onClick={() => setMobileMenuOpen(false)}>
                                <X className="w-6 h-6" />
                            </button>
                        </div>
